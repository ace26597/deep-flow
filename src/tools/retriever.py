...
class RetrieverTool(BaseTool):
    ...
    description: str = "Useful for retrieving information from the file with `rag://` uri prefix or MongoDB collections. It performs vector search on chunks and file summaries. Input should be search keywords."
